...
async function createOrdersTable() {
  ...
  if (checkError.code !== 'PGRST116' && checkError.code !== '42P01') {
    // Some other error, not "relation does not exist"
    console.log('Table might exist or other issue:', checkError.message);
  }

  console.log('\n===============================================');
  console.log('Please create the "orders" table manually in Supabase SQL Editor:');
